...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "features.curated_desc": "Covering proxy cores, GUI clients, subscription management, GitHub acceleration, DNS tools and 21 categories",
    ...
    "categories.title": "21 Professional Categories",
    "categories.subtitle": "From proxy cores to security tools — comprehensive coverage",
    ...
    "explore.description": "Browse and search 120+ curated network tools across 21 categories. Filter by proxy, VPN, Clash, DNS, security tools and more.",
  ...
  zh: {
    ...
    "features.curated_desc": "涵盖代理核心、GUI 客户端、订阅管理、GitHub 加速、DNS 工具等 21 个分类",
    ...
    "categories.title": "21 个专业分类",
    "categories.subtitle": "从代理核心到安全工具 — 全面覆盖",
    ...
    "explore.description": "浏览和搜索 120+ 个精选网络工具，涵盖 21 个分类。按代理、VPN、Clash、DNS、安全工具等筛选。",
  ...
  ja: {
    ...
    "features.curated_desc": "プロキシコア、GUIクライアント、サブスクリプション管理、GitHub高速化、DNSツールなど21カテゴリをカバー",
    ...
    "categories.title": "21の専門カテゴリ",
    "categories.subtitle": "プロキシコアからセキュリティツールまで — 包括的にカバー",
    ...
    "explore.title": "探索 - NetTools Hub",
    "explore.description": "120+の厳選ネットワークツールを21カテゴリから閲覧・検索。プロキシ、VPN、Clash、DNS、セキュリティツールでフィルタリング。",
